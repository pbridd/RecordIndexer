...
public class FormEntryPanel extends JPanel implements BatchStateListener, ActionListener, ListSelectionListener, 
	FocusListener, MouseListener, Serializable{
	...
	private void createComponents(){
		...
		for(int i = 0; i < bchS.getFields().size(); i++){
			...
			tempTextField.addMouseListener(this);
	...
	public void actionPerformed(ActionEvent arg0) {
		if(arg0.getSource() == seeSugMenuItem){
			SuggestionsDialog suggestions = new SuggestionsDialog(table.getChecker(rightClickedCol), bchS,
					rightClickedRow, rightClickedCol);
			suggestions.pack();
	...
	public void mousePressed(MouseEvent arg0) {
		for(int i = 0; i < inputFields.size(); i++){
			JTextField tf = inputFields.get(i);
			if(arg0.getSource() == tf){
				if(arg0.getButton() == MouseEvent.BUTTON3){
					if(!table.getIsKnownWord(tf.getText(), i+1)){
						rightClickedRow = recordList.getSelectedIndex();
						rightClickedCol = i;
						sugMenu.show(arg0.getComponent(), arg0.getX(), arg0.getY());
